import * as agChartsEnterprise from '@ag-charts-enterprise/ag-charts-enterprise';
import { AgChartOptions, _ModuleSupport } from '@ag-charts-enterprise/ag-charts-enterprise';
